...
class RoomCalendarController extends Controller
{
    ...
    public function searchAvailability(Request $request){
        ...
        $start_dt = \Carbon\Carbon::createFromFormat('d-m-Y', $request['start_dt'])->toDateTimeString();
        $end_dt =   \Carbon\Carbon::createFromFormat('d-m-Y', $request['end_dt'])->toDateTimeString();
